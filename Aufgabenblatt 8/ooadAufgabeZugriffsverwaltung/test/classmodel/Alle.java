...
/** Diese Klasse ermoeglicht es nach vorhandenen Klassen zu suchen 
...
public class Alle {
    ...
    public static boolean methodeLiefertErgebnis(String erwartet, 
        ...
        try {
            ...
            throw new IllegalArgumentException("Von Klasse "
                    ...
                    + " darf ein Aufruf nicht stattfinden: " + ex);
        }
    }
     ...
     * wenn statt einmer Klasse dein Interface betrachtet wird, wird
...
//                + " - " + moeglicheClassObjekteFuer(oberklasse));
    ...
    public static List<String> klasseHatVariableMitName(String klasse
            , String variable){
        if(klasse == null){
            throw new IllegalArgumentException("Klasse null existiert nicht und hat damit keine Variable");
        }        
        if(variable == null){
            throw new IllegalArgumentException("Variable kann nicht den Namen null haben");
        }
    ...
    public static Class existiertKlasse(String name) {
        if(name == null){
            throw new IllegalArgumentException("Existenz der Klasse null versucht zu pruefen");
        }
        if (istBasistyp(name)) {
    ...
    public static Object erzeugeObjektMitKonstruktor(
        ...
        try {
            ...
            throw new IllegalArgumentException("Konstruktornutzung von "
                    ...
                    + Arrays.asList(parameter) + " gescheitert: " + e);
        }
    } 
    ...
    public static Object fuehreAufObjektMethodeMitParameternAus(
        ...
        if(methode == null){
            throw new IllegalArgumentException("Zu nutzendes Methode kann nicht null sein");
        }        
        try {
            methode.setAccessible(true);
            return methode.invoke(objekt, parameter);
        } catch (Exception e) {
            throw new IllegalArgumentException("Methodenaufruf gescheitert: " + e);
        }
    }
